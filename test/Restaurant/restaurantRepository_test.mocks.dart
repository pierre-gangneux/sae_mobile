...
// in sae_mobile/test/Restaurant/restaurantRepository_test.dart.
...
import 'package:sae_mobile/Model/Cuisine/CuisineRepository.dart' as _i6;
import 'package:sae_mobile/Model/Restaurant/Restaurant.dart' as _i7;
...
/// A class which mocks [CuisineRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockCuisineRepository extends _i1.Mock implements _i6.CuisineRepository {
  ...
  List<String> get cuisines =>
      (super.noSuchMethod(Invocation.getter(#cuisines), returnValue: <String>[])
          as List<String>);

  @override
  set cuisines(List<String>? _cuisines) => super.noSuchMethod(
    Invocation.setter(#cuisines, _cuisines),
    returnValueForMissingStub: null,
  );

  @override
  List<String> get cuisinesRestaurant =>
      (super.noSuchMethod(
            Invocation.getter(#cuisinesRestaurant),
            returnValue: <String>[],
          )
          as List<String>);

  @override
  set cuisinesRestaurant(List<String>? _cuisinesRestaurant) =>
      super.noSuchMethod(
        Invocation.setter(#cuisinesRestaurant, _cuisinesRestaurant),
        returnValueForMissingStub: null,
      );

  @override
  _i3.Future<void> loadCuisines() =>
      (super.noSuchMethod(
            Invocation.method(#loadCuisines, []),
            returnValue: _i3.Future<void>.value(),
            returnValueForMissingStub: _i3.Future<void>.value(),
          )
          as _i3.Future<void>);
  ...
  @override
  _i3.Future<void> loadCuisinesRestaurant(_i7.Restaurant? restaurant) =>
      (super.noSuchMethod(
            Invocation.method(#loadCuisinesRestaurant, [restaurant]),
            returnValue: _i3.Future<void>.value(),
            returnValueForMissingStub: _i3.Future<void>.value(),
          )
          as _i3.Future<void>);
  ...
  List<String> getCuisinesRestaurant() =>
      (super.noSuchMethod(
            Invocation.method(#getCuisinesRestaurant, []),
            returnValue: <String>[],
          )
          as List<String>);
}
